...
public class Memo extends JFrame implements ActionListener, Serializable {
   ...
   public Memo() {
      ...
      File ff = new File("E://testFile/memoObject.txt");
      if(ff.exists()) { //
   ...
   public void fileWrite() {
      try {
         File f = new File("E://testFile/memoObject.txt");
   ...
   public void fileSave() {
      JFileChooser fc = new JFileChooser(new File("E://testFile"));
   ...
   public void fileOpen() {
      JFileChooser fc = new JFileChooser(new File("E://JavaSrc"));
